...
List<MyProductModel> myProductModel = [
  ...
  MyProductModel(
    image: 'assets/images/kurume_ramen.png',
    name: 'Kurume Ramen',
    price: 4.3,
    rate: 4.9,
    distance: 600,
  ...
  MyProductModel(
    image: 'assets/images/hakata_ramen.png',
    name: 'Hakata Ramen',
    price: 3.9,
    distance: 400,
    rate: 4.8,
  ...
  MyProductModel(
    image: 'assets/images/fullset_ramen.png',
    name: 'Fullset Ramen',
    price: 5.9,
    distance: 400,
    rate: 4.7,
  ...
  //for burger
  MyProductModel(
    image: 'assets/images/grilled-beef-burger.png',
